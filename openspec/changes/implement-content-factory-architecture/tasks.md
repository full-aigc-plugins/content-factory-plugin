...
58 个父任务沿用 CF-001–CF-058；每个拆成四个子项，共 232 个，全部未开始。本文件是执行明细，不增加第二套独立产品任务。父任务只能在其子项、原验收和所需真实证据都完成后汇总；不得仅凭子项数更新父任务。原 58 项文本保留不覆盖，受影响实现职责以已确认的 Vendor/单 Harness 决策为准。
...
- [ ] 1.1 [CF-001.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 1.2 [CF-001.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 1.3 [CF-001.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 1.4 [CF-001.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 7.1 [CF-007.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 7.2 [CF-007.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 7.3 [CF-007.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 7.4 [CF-007.4] 原要求与证据复核、独立 review/commit。

## 8. CF-008 — TXT/Markdown 素材导入与去重

[详细任务卡](task-details/foundation.md#cf-008)

- [ ] 8.1 [CF-008.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 8.2 [CF-008.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 8.3 [CF-008.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 8.4 [CF-008.4] 原要求与证据复核、独立 review/commit。

## 9. CF-009 — 受控 URL 读取、正文提取与来源定位

[详细任务卡](task-details/foundation.md#cf-009)

- [ ] 9.1 [CF-009.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 9.2 [CF-009.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 9.3 [CF-009.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 9.4 [CF-009.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 11.1 [CF-011.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 11.2 [CF-011.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 11.3 [CF-011.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 11.4 [CF-011.4] 原要求与证据复核、独立 review/commit。

## 12. CF-012 — Run/Step 账本与恢复执行

[详细任务卡](task-details/foundation.md#cf-012)

- [ ] 12.1 [CF-012.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 12.2 [CF-012.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 12.3 [CF-012.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 12.4 [CF-012.4] 原要求与证据复核、独立 review/commit。

## 13. CF-013 — 唯一 content-harness 与任务模式编排

[详细任务卡](task-details/foundation.md#cf-013)

- [ ] 13.1 [CF-013.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 13.2 [CF-013.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 13.3 [CF-013.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 13.4 [CF-013.4] 原要求与证据复核、独立 review/commit。

## 14. CF-014 — 作者档案与术语保护

[详细任务卡](task-details/foundation.md#cf-014)

- [ ] 14.1 [CF-014.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 14.2 [CF-014.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 14.3 [CF-014.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 14.4 [CF-014.4] 原要求与证据复核、独立 review/commit。

## 15. CF-015 — 研究、SourceBundle 与 ClaimRegistry

[详细任务卡](task-details/foundation.md#cf-015)

- [ ] 15.1 [CF-015.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 15.2 [CF-015.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 15.3 [CF-015.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 15.4 [CF-015.4] 原要求与证据复核、独立 review/commit。

## 16. CF-016 — 五类内容模板与 Vendor 写作适配

[详细任务卡](task-details/foundation.md#cf-016)

- [ ] 16.1 [CF-016.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 16.2 [CF-016.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 16.3 [CF-016.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 16.4 [CF-016.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 18.1 [CF-018.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 18.2 [CF-018.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 18.3 [CF-018.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 18.4 [CF-018.4] 原要求与证据复核、独立 review/commit。

## 19. CF-019 — 一稿多用的派生版本

[详细任务卡](task-details/foundation.md#cf-019)

- [ ] 19.1 [CF-019.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 19.2 [CF-019.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 19.3 [CF-019.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 19.4 [CF-019.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 21.1 [CF-021.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 21.2 [CF-021.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 21.3 [CF-021.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 21.4 [CF-021.4] 原要求与证据复核、独立 review/commit。

## 22. CF-022 — 确定性 Markdown/HTML 渲染与文字冻结

[详细任务卡](task-details/production-delivery.md#cf-022)

- [ ] 22.1 [CF-022.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 22.2 [CF-022.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 22.3 [CF-022.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 22.4 [CF-022.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 24.1 [CF-024.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 24.2 [CF-024.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 24.3 [CF-024.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 24.4 [CF-024.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 37.1 [CF-037.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 37.2 [CF-037.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 37.3 [CF-037.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 37.4 [CF-037.4] 原要求与证据复核、独立 review/commit。

## 38. CF-038 — 崩溃、重复提交与依赖故障回归

[详细任务卡](task-details/production-delivery.md#cf-038)

- [ ] 38.1 [CF-038.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 38.2 [CF-038.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 38.3 [CF-038.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 38.4 [CF-038.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 44.1 [CF-044.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 44.2 [CF-044.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 44.3 [CF-044.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 44.4 [CF-044.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 47.1 [CF-047.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 47.2 [CF-047.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 47.3 [CF-047.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 47.4 [CF-047.4] 原要求与证据复核、独立 review/commit。

## 48. CF-048 — Channel-specialized candidate conformance

[详细任务卡](task-details/platforms.md#cf-048)

- [ ] 48.1 [CF-048.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 48.2 [CF-048.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 48.3 [CF-048.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 48.4 [CF-048.4] 原要求与证据复核、独立 review/commit。

## 49. CF-049 — Runtime eligibility, progressive loading and fallback

[详细任务卡](task-details/platforms.md#cf-049)

- [ ] 49.1 [CF-049.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 49.2 [CF-049.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 49.3 [CF-049.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 49.4 [CF-049.4] 原要求与证据复核、独立 review/commit。

## 50. CF-050 — Channel-native source-grounded writing and editing

[详细任务卡](task-details/platforms.md#cf-050)

- [ ] 50.1 [CF-050.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 50.2 [CF-050.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 50.3 [CF-050.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 50.4 [CF-050.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 52.1 [CF-052.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 52.2 [CF-052.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 52.3 [CF-052.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 52.4 [CF-052.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 54.1 [CF-054.1] 正反例 fixture 与精确断言，确认业务 RED。
- [ ] 54.2 [CF-054.2] 实现任务卡输入输出和拒绝路径，确认 GREEN。
- [ ] 54.3 [CF-054.3] 目标测试、typecheck、lint、直接依赖回归。
- [ ] 54.4 [CF-054.4] 原要求与证据复核、独立 review/commit。
...
- [ ] 58.1 [CF-058.1] 正反例 fixture 与精确断言，确认业务 RED。
